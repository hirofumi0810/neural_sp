...
vocab_size_sub2=1000
unit_sub3=char
wp_type_sub3=bpe  # or unigram (for wordpiece)
vocab_size_sub3=
...
if [ ${stage} -le 4 ]; then
  ...
  CUDA_VISIBLE_DEVICES=${gpu} ../../../neural_sp/bin/asr/train.py \
    ...
    --train_set_sub3 ${data}/dataset/${train_set}_${unit_sub3}${wp_type_sub3}${vocab_size_sub3}.csv \
    ...
    --dev_set_sub3 ${data}/dataset/${dev_set}_${unit_sub3}${wp_type_sub3}${vocab_size_sub3}.csv \
    --dict ${dict} \
    --dict_sub1 ${dict_sub1} \
    --dict_sub2 ${dict_sub2} \
    --dict_sub3 ${dict_sub3} \
    ...
    --enc_nlayers_sub3 ${enc_nlayers_sub3} \
    ...
    --dec_nlayers_sub3 ${dec_nlayers_sub3} \
