...
class Dataset(DatasetBase):
    ...
    def __init__(self, data_type, data_size, label_type,
        ...
        # NOTE: ex.) librispeech/inputs/data_size/data_type/speaker/*.npy
        label_path = join(
            dataset_root[0], 'labels', data_size, data_type, label_type)
        # NOTE: ex.)
        # librispeech/labels/data_size/data_type/label_type/speaker/*.npy
