...
"""Train the hierarchical ASR model (WSJ corpus)."""
...
def main():
    ...
    train_data = Dataset(
        ...
        data_type=config['data_size'], data_size=config['data_size'],
    ...
    dev_data = Dataset(
        ...
        use_delta=config['use_delta'],
        use_double_delta=config['use_double_delta'],
        data_type='test_dev93', data_size=config['data_size'],
        label_type=config['label_type'],
        label_type_sub=config['label_type_sub'],
    ...
    test_data = Dataset(
        ...
        use_delta=config['use_delta'],
        use_double_delta=config['use_double_delta'],
        data_type='test_eval92', data_size=config['data_size'],
        label_type=config['label_type'],
        label_type_sub=config['label_type_sub'],
    ...
    # Set process name
    setproctitle('wsj_' + config['backend'] + '_' + config['model_type'] + '_' +
