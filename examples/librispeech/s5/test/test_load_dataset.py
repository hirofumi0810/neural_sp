...
class TestLoadDataset(unittest.TestCase):
    ...
    def test(self):
        ...
        # data_size
        self.check(label_type='character', data_size='460')
        self.check(label_type='character', data_size='960')
        ...
        self.check(label_type='character', sort_utt=True, sort_stop_epoch=2)
        self.check(label_type='character', shuffle=True)

    @measure_time
    def check(self, label_type='character', data_type='dev_clean', data_size='100',
