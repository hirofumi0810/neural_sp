...
SWBD_DATAPATH="/n/sd8/inaguma/corpus/swbd/data/LDC97S62"
FISHER_DATAPATH='/n/sd8/inaguma/corpus/swbd/data/fisher'
...
export FISHERDATA_SAVEPATH=/"home/lab5/inaguma/corpus/swbd/kaldi"
...
local/swbd1_data_download.sh $SWBD_DATAPATH
...
local/swbd1_data_prep.sh $SWBD_DATAPATH

# utils/prepare_lang.sh $FISHERDATA_SAVEPATH/local/dict_nosp \
#     "<unk>" $FISHERDATA_SAVEPATH/local/lang_nosp $FISHERDATA_SAVEPATH/lang_nosp
...
#  $FISHERDATA_SAVEPATH/local/train_swbd/text $FISHERDATA_SAVEPATH/local/dict/lexicon.txt $FISHERDATA_SAVEPATH/local/lm
...
LM=$FISHERDATA_SAVEPATH/local/lm/3gram-mincount/lm_unpruned.gz
srilm_opts="-subset -prune-lowprobs -unk -tolower -order 3"
utils/format_lm_sri.sh --srilm-opts "$srilm_opts" \
  $FISHERDATA_SAVEPATH/lang_nosp $LM $FISHERDATA_SAVEPATH/local/dict_nosp/lexicon.txt $FISHERDATA_SAVEPATH/lang_nosp_fsh_sw1_tg

LM_fg=$FISHERDATA_SAVEPATH/local/lm/4gram-mincount/lm_unpruned.gz
[ -f $LM_fg ] || rescore=false
if [ $rescore ]; then
  utils/build_const_arpa_lm.sh $LM_fg $FISHERDATA_SAVEPATH/lang_nosp $FISHERDATA_SAVEPATH/lang_nosp_fsh_sw1_fg
fi
...
utils/data/remove_dup_utts.sh 300 data/train $FISHERDATA_SAVEPATH/train_nodup
...
steps/train_mono.sh --nj 3 --cmd "$train_cmd" \
  data/train_10k_nodup $FISHERDATA_SAVEPATH/lang_nosp exp/mono0a

steps/align_si.sh --nj 10 --cmd "$train_cmd" \
   data/train_30k_nodup $FISHERDATA_SAVEPATH/lang_nosp exp/mono0a exp/mono0a_ali || exit 1;

steps/train_deltas.sh --cmd "$train_cmd" \
    3200 30000 data/train_30k_nodup $FISHERDATA_SAVEPATH/lang_nosp exp/mono0a_ali exp/tri1a || exit 1;
#used to be 2500 20000
(
 graph_dir=exp/tri1a/graph_nosp_fsh_sw1_tg
 utils/mkgraph.sh $FISHERDATA_SAVEPATH/lang_nosp_fsh_sw1_tg exp/tri1a $graph_dir
...
steps/align_si.sh --nj 10 --cmd "$train_cmd" \
   data/train_30k_nodup $FISHERDATA_SAVEPATH/lang_nosp exp/tri1a exp/tri1a_ali || exit 1;

steps/train_deltas.sh --cmd "$train_cmd" \
    3200 30000 data/train_30k_nodup $FISHERDATA_SAVEPATH/lang_nosp exp/tri1a_ali exp/tri1b || exit 1;
#used to be 2500 20000
(
 graph_dir=exp/tri1b/graph_nosp_fsh_sw1_tg
 utils/mkgraph.sh $FISHERDATA_SAVEPATH/lang_nosp_fsh_sw1_tg exp/tri1b $graph_dir
 steps/decode.sh --nj 25 --cmd "$decode_cmd" --config conf/decode.config \
...
steps/align_si.sh --nj 50 --cmd "$train_cmd" \
   data/train_100k_nodup $FISHERDATA_SAVEPATH/lang_nosp exp/tri1b exp/tri1b_ali || exit 1;

steps/train_deltas.sh --cmd "$train_cmd" \
    5500 90000 data/train_100k_nodup $FISHERDATA_SAVEPATH/lang_nosp exp/tri1b_ali exp/tri2 || exit 1;
 #used to be 2500 20000 on 30k
(
  graph_dir=exp/tri2/graph_nosp_fsh_sw1_tg
  utils/mkgraph.sh $FISHERDATA_SAVEPATH/lang_nosp_fsh_sw1_tg exp/tri2 $graph_dir || exit 1;
  steps/decode.sh --nj 25 --cmd "$decode_cmd" --config conf/decode.config \
...
steps/align_si.sh --nj 100 --cmd "$train_cmd" \
   data/train_swbd $FISHERDATA_SAVEPATH/lang_nosp exp/tri2 exp/tri2_ali || exit 1;

steps/train_deltas.sh --cmd "$train_cmd" \
    11500 200000 data/train_swbd $FISHERDATA_SAVEPATH/lang_nosp exp/tri2_ali exp/tri3a || exit 1;
 #used to be 2500 20000

(
  graph_dir=exp/tri3a/graph_nosp_fsh_sw1_tg
  utils/mkgraph.sh $FISHERDATA_SAVEPATH/lang_nosp_fsh_sw1_tg exp/tri3a $graph_dir || exit 1;
  steps/decode.sh --nj 25 --cmd "$decode_cmd" --config conf/decode.config \
...
steps/align_si.sh --nj 100 --cmd "$train_cmd" \
  $FISHERDATA_SAVEPATH/train_nodup $FISHERDATA_SAVEPATH/lang_nosp exp/tri3a exp/tri3a_ali || exit 1;

steps/train_lda_mllt.sh --cmd "$train_cmd" \
   --splice-opts "--left-context=3 --right-context=3" \
   11500 400000 $FISHERDATA_SAVEPATH/train_nodup $FISHERDATA_SAVEPATH/lang_nosp exp/tri3a_ali exp/tri3b || exit 1;
(
  graph_dir=exp/tri3b/graph_nosp_fsh_sw1_tg
  utils/mkgraph.sh $FISHERDATA_SAVEPATH/lang_nosp_fsh_sw1_tg exp/tri3b $graph_dir || exit 1;
...
steps/get_prons.sh --cmd "$train_cmd" $FISHERDATA_SAVEPATH/train_nodup $FISHERDATA_SAVEPATH/lang_nosp exp/tri3b

utils/dict_dir_add_pronprobs.sh --max-normalize true \
  $FISHERDATA_SAVEPATH/local/dict_nosp exp/tri3b/pron_counts_nowb.txt exp/tri3b/sil_counts_nowb.txt \
  exp/tri3b/pron_bigram_counts_nowb.txt $FISHERDATA_SAVEPATH/local/dict

utils/prepare_lang.sh $FISHERDATA_SAVEPATH/local/dict "<unk>" $FISHERDATA_SAVEPATH/local/lang $FISHERDATA_SAVEPATH/lang

LM=$FISHERDATA_SAVEPATH/local/lm/3gram-mincount/lm_unpruned.gz
srilm_opts="-subset -prune-lowprobs -unk -tolower -order 3"
utils/format_lm_sri.sh --srilm-opts "$srilm_opts" \
  $FISHERDATA_SAVEPATH/lang $LM $FISHERDATA_SAVEPATH/local/dict/lexicon.txt $FISHERDATA_SAVEPATH/lang_fsh_sw1_tg

LM_fg=$FISHERDATA_SAVEPATH/local/lm/4gram-mincount/lm_unpruned.gz
if [ $rescore ]; then
  utils/build_const_arpa_lm.sh $LM_fg $FISHERDATA_SAVEPATH/lang $FISHERDATA_SAVEPATH/lang_fsh_sw1_fg
fi

(
  graph_dir=exp/tri3b/graph_fsh_sw1_tg
  utils/mkgraph.sh $FISHERDATA_SAVEPATH/lang_fsh_sw1_tg exp/tri3b $graph_dir || exit 1;
  steps/decode_fmllr.sh --nj 25 --cmd "$decode_cmd" --config conf/decode.config \
...
steps/align_fmllr.sh --nj 100 --cmd "$train_cmd" \
  $FISHERDATA_SAVEPATH/train_nodup $FISHERDATA_SAVEPATH/lang exp/tri3b exp/tri3b_ali || exit 1;

steps/train_sat.sh  --cmd "$train_cmd" \
  11500 800000 $FISHERDATA_SAVEPATH/train_nodup $FISHERDATA_SAVEPATH/lang exp/tri3b_ali  exp/tri4a || exit 1;

(
  graph_dir=exp/tri4a/graph_fsh_sw1_tg
  utils/mkgraph.sh $FISHERDATA_SAVEPATH/lang_fsh_sw1_tg exp/tri4a $graph_dir
  steps/decode_fmllr.sh --nj 25 --cmd "$decode_cmd" --config conf/decode.config \
...
if [ $rescore ]; then
  steps/lmrescore_const_arpa.sh --cmd "$decode_cmd" \
    $FISHERDATA_SAVEPATH/lang_fsh_sw1_{tg,fg} data/eval2000 \
    exp/tri4a/decode_eval2000_fsh_sw1_{tg,fg}
  steps/lmrescore_const_arpa.sh --cmd "$decode_cmd" \
    $FISHERDATA_SAVEPATH/lang_fsh_sw1_{tg,fg} data/rt03 \
    exp/tri4a/decode_rt03_fsh_sw1_{tg,fg}
fi

steps/align_fmllr.sh --nj 100 --cmd "$train_cmd" \
  $FISHERDATA_SAVEPATH/train_nodup $FISHERDATA_SAVEPATH/lang exp/tri4a exp/tri4a_ali || exit 1;

steps/train_sat.sh  --cmd "$train_cmd" \
  11500 1600000 $FISHERDATA_SAVEPATH/train_nodup $FISHERDATA_SAVEPATH/lang exp/tri4a_ali  exp/tri5a || exit 1;

(
  graph_dir=exp/tri5a/graph_fsh_sw1_tg
  utils/mkgraph.sh $FISHERDATA_SAVEPATH/lang_fsh_sw1_tg exp/tri5a $graph_dir
  steps/decode_fmllr.sh --nj 25 --cmd "$decode_cmd" --config conf/decode.config \
...
steps/align_fmllr.sh --nj 100 --cmd "$train_cmd" \
  $FISHERDATA_SAVEPATH/train_nodup $FISHERDATA_SAVEPATH/lang exp/tri5a exp/tri5a_ali || exit 1;


steps/train_sat.sh  --cmd "$train_cmd" \
  11500 3200000 $FISHERDATA_SAVEPATH/train_nodup $FISHERDATA_SAVEPATH/lang exp/tri5a_ali  exp/tri6a || exit 1;

(
  graph_dir=exp/tri6a/graph_fsh_sw1_tg
  utils/mkgraph.sh $FISHERDATA_SAVEPATH/lang_fsh_sw1_tg exp/tri6a $graph_dir
  steps/decode_fmllr.sh --nj 25 --cmd "$decode_cmd" --config conf/decode.config \
...
#  $FISHERDATA_SAVEPATH/train_nodup $FISHERDATA_SAVEPATH/lang exp/tri6a exp/tri6a_ali || exit 1;
