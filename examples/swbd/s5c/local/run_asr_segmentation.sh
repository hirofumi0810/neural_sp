...
lang=$DATA_SAVEPATH/lang   # Must match the one used to train the models
lang_test=$DATA_SAVEPATH/lang_nosp_sw1_tg  # Lang directory for decoding.

data_dir=$DATA_SAVEPATH/train_nodup
