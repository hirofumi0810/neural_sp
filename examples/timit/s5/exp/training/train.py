...
"""Train the ASR model (TIMIT corpus)."""
...
def main():
    ...
    train_data = Dataset(
        ...
        data_type='train', label_type=config['label_type'],
    ...
    dev_data = Dataset(
        ...
        use_delta=config['use_delta'],
        use_double_delta=config['use_double_delta'],
        data_type='dev', label_type=config['label_type'],
    ...
    if args.model_save_path is not None:
        ...
        save_path = mkdir_join(
            ...
            config['model_type'], config['label_type'], model.name)
    ...
    # Set process name
    setproctitle('timit_' + config['backend'] + '_' +
                 config['model_type'] + '_' + config['label_type'])
