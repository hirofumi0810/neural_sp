...
@pytest.mark.parametrize(
    "args", [
        ...
        #   'bidirectional_sum_fwd_bwd': True}),
        # projection
        ({'rnn_type': 'blstm', 'n_projs': 128}),
        ({'rnn_type': 'lstm', 'n_projs': 128}),
        ({'rnn_type': 'blstm', 'bidirectional_sum_fwd_bwd': True}),
        # ({'rnn_type': 'blstm', 'n_projs': 128, 'bidirectional_sum_fwd_bwd': True}),
        ({'rnn_type': 'blstm', 'last_proj_dim': 512}),
        ({'rnn_type': 'blstm', 'n_projs': 128, 'last_proj_dim': 512}),
        ({'rnn_type': 'lstm', 'n_projs': 128, 'last_proj_dim': 512}),
        ({'rnn_type': 'blstm', 'bidirectional_sum_fwd_bwd': True, 'last_proj_dim': 512}),
        # ({'rnn_type': 'blstm', 'n_projs': 128, 'bidirectional_sum_fwd_bwd': True, 'last_proj_dim': 512}),
        # LC-BLSTM
