...
class TestAttention(unittest.TestCase):
    ...
    def test(self):
        ...
        # self.check(encoder_type='lstm', bidirectional=True,
        #            decoder_type='lstm', decoding_order='conditional')  # TODO: check to work
        ...
        # self.check(encoder_type='lstm', bidirectional=True,
        #            decoder_type='lstm', attention_type='content', num_heads=2)  #TODO:
        # self.check(encoder_type='lstm', bidirectional=True,
        #            decoder_type='lstm', attention_type='location', num_heads=2) # TODO
        # self.check(encoder_type='lstm', bidirectional=True,
        #            decoder_type='lstm', attention_type='dot_product', num_heads=2) # TODO:
        ...
        for step in range(max_step):
            ...
            if (step + 1) % 10 == 0:
                ...
                best_hyps, _,  _ = model.decode(
                    xs, x_lens, beam_width=beam_width, max_decode_len=60)
